    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-8 flex justify-between items-center h-16">
          ...
          <ul className="flex gap-8 font-medium">
            {navItems.map((item, index) => (
              ...
              >
                <a
                  href={item.href}
                  className={`relative py-2 px-1 transition-colors duration-300 ${isDark ? 'text-gray-200 hover:text-orange-400' : 'text-gray-700 hover:text-orange-600'
                    }`}
                >
                  {item.name}
                  <motion.span
        ...
        <div className="md:hidden flex items-center gap-4">
          ...
          <button
            className={`p-2 transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-700'
              }`}
              ...
              {navItems.map((item, index) => (
                ...
                >
                  <a
                    ...
                    className={`block py-2 font-medium transition-colors duration-300 ${isDark ? 'text-gray-200 hover:text-orange-400' : 'text-gray-700 hover:text-orange-600'
                      }`}
                  >
                    {item.name}
                  </a>
