    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          ...
          className={`absolute top-10 left-10 w-80 h-80 rounded-full opacity-5 ${isDark ? 'bg-gradient-to-r from-orange-500 to-yellow-500' : 'bg-gradient-to-r from-orange-300 to-yellow-300'
            }`}
        />
        <motion.div
          animate={{
          ...
          className={`absolute bottom-10 right-10 w-60 h-60 rounded-full opacity-5 ${isDark ? 'bg-gradient-to-r from-yellow-500 to-orange-500' : 'bg-gradient-to-r from-yellow-300 to-orange-300'
            }`}
        />
      </div>
      ...
      >
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 space-y-6">
                  ...
                  >
                    {['Premium Quality', 'Fast Delivery', 'Custom Design'].map((feature, i) => (
                      <span
                        key={i}
                        className={`px-4 py-2 rounded-full text-sm font-medium border ${isDark
                ...
                <div className="flex-1 relative group">
                  <motion.div
                    className={`relative rounded-2xl overflow-hidden shadow-2xl ${isDark ? 'shadow-orange-500/20' : 'shadow-orange-500/30'
                      }`}
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className={`absolute -top-4 -right-4 w-20 h-20 rounded-full flex items-center justify-center backdrop-blur-sm border ${isDark
        ...
        >
          <motion.div
            ...
            whileTap={{ scale: 0.95 }}
            className={`inline-flex items-center gap-3 px-8 py-4 rounded-full font-semibold cursor-pointer transition-all duration-300 ${isDark
